	...
	//adjustDocSize(WDTH,HGHT,400,400,PAD);
        ...
        if(frame_w > 0 && frame_h > 0){
          ...
          // draw the glass
            ...
            trace("frame_w = " + frame_w);
            trace("frame_h = " + frame_h);
            trace("bead_partWidth = " + bead_partWidth);
            trace("frame_leftWidth = " + frame_leftWidth);
            trace("frame_headWidth = " + frame_headWidth);
            trace("frame_rightWidth = " + frame_rightWidth);
            trace("frame_sillWidth = " + frame_sillWidth);
            trace("bead_x = " + bead_x);
            trace("bead_y = " + bead_y);
            trace("bead_w = " + bead_w);
            trace("glass_x = " + glass_x);
            trace("glass_y = " + glass_y);
            trace("glass_y = " + glass_w);
            trace("InitGlass");
            trace("initGlassEllipse('glass',"+'bead'+","+ glass_x +","+ glass_y +","+ glass_w +","+ glass_h +","+ 0 +","+ 0 +","+ glass_color +")")
            initGlassEllipse("glass","bead",glass_x, glass_y, glass_w, glass_h, 0, 0, glass_color)
